...
window.sendEmail = function sendEmail () {
  // console.log('>>', ev)
  // ev.preventDefault()
  var email = window.emailInput.value
  window.axios.get('/?a=' + email)
  window.emailWrapper.innerHTML = "Thank you! We'll be in within 24h"
}

// window.emailSubmitBtn.addEventListener('onclick', sendEmail, true)
